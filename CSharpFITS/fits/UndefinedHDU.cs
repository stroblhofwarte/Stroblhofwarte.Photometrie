namespace nom.tam.fits
{
   ...
   */
    using System;
    using ArrayFuncs = util.ArrayFuncs;
	...
	public class UndefinedHDU : BasicHDU
    {
        ...
        public override void Info()
        {
            ...
            Console.Out.WriteLine("  Unhandled/Undefined/Unknown Type");
            Console.Out.WriteLine($"  XTENSION={myHeader.GetStringValue("XTENSION").Trim()}");
            Console.Out.WriteLine($"  Apparent size:{myData.TrueSize}");
        }
    }
}