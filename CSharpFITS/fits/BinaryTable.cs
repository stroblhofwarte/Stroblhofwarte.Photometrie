        ...
        public override void Read(ArrayDataIO i)
        {
            ...
            if (i is util.RandomAccess)
            {
                try
                {
                    ...
                    var temp_Int64 =
                        //temp_BinaryReader = i;
                        i.Position; //temp_BinaryReader.BaseStream.Position;
                    ...
                    var temp_Int65 =
                        ...
                        i.Position; //temp_BinaryReader2.BaseStream.Position;
		...
		private Object ColumnToArray(int col, Object o, int rows)
        {
            ...
            if (IsVarCol(col))
            {
                ...
                if (IsLongVary(col))
                {
                    ...
                    {
                        Console.Out.WriteLine("Warning: converting long variable array pointers to int's");
