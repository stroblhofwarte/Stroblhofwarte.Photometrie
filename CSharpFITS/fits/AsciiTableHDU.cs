namespace nom.tam.fits
{
    ...
    public class AsciiTableHDU : TableHDU
    {
        ...
        /// </summary>
        private readonly String[] keyStems = { "TFORM", "TZERO", "TNULL", "TTYPE", "TUNIT" };
        ...
        public new static bool IsHeader(Header header)
        {
		...
		public static bool IsData(Object o)
        {
            ...
            */
            if (o is Object[])
            {
                ...
                {
                    if (oo[i] is String[] || oo[i] is int[] || oo[i] is long[] || oo[i] is float[] || oo[i] is double[])
                    {
                        continue;
                    }
                    return false;
        ...
        public override void Info()
        {
            ...
            {
                Console.Out.WriteLine($"      {i}:{ArrayFuncs.ArrayDescription(data.GetValue(i))}");
            }
        }
