    ...
    */
    ...
    public class ImageData : Data
    {
        ...
        protected internal class ImageDataTiler : ImageTiler
        {
            ...
            internal ImageDataTiler(ImageData enclosingInstance, util.RandomAccess o, long offset, ArrayDesc d) : base(o, offset, d.dims, d.type)
            {
                InitBlock(enclosingInstance);
            }
        ...
        public override void Read(ArrayDataIO i)
        {
            ...
            if (i.CanSeek)
            {
                ...
                tiler = new ImageDataTiler(this, (util.RandomAccess)i, i.Position, dataDescription);
                try
                {
