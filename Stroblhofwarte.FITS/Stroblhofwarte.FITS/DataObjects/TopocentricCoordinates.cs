...
namespace Stroblhofwarte.FITS.DataObjects
{
    ...
    public class TopocentricCoordinates
    {
        ...
        {
            return Transform(epoch, 0.0d, 0.0d, 0.0d, 0.0d);
        }
        ...
        public Coordinates Transform(Epoch epoch, double pressurehPa, double tempCelcius, double relativeHumidity, double wavelength)
        {
